...
const productController = require('./controllers/productLogs')
const skinController = require('./controllers/skinProfiles')
const progressController = require('./controllers/progressLogs')
...
app.get('/product', productController.getProductDetails);
app.get('/allproducts', productController.getAllProductLogs);
app.get('/progressID', progressController.getProgressLogsByUserID);
app.get('/skinID',skinController.getSkinProfileByUserID);
